...
<html>
<head>
	<title><spring:message code="AlluvusRaport.label.title"/></title>
...
<!-- Filters -->			<table>
								<tr>
									<td style="width: 170px;"><spring:message code="AlluvusRaport.label.date"/>:</td>					
									<td style="width: 170px;"><spring:message code="AlluvusRaport.label.type"/>:</td>
									<td style="width: 80px;"/>						
								</tr>
								<tr>
		<!-- Date --> 				<td>				
		...
		<!-- Refresh button -->			<td>
									 	<input 	type	= "button" 
									 			value	= "<spring:message code="AlluvusRaport.button.refresh"/>" 
									 			class 	= "largeButton"  
...
<!-- Results -->			<c:forEach var="unit" items="${units}">
	...
	<!-- View subUnit -->								<td align="right">
														 	<input 	type	= "button" 
														 			value	= "<spring:message code="AlluvusRaport.button.look"/>" 
														 			class 	= "largeButton"  
