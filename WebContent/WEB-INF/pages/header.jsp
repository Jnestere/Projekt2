...
<div style="overflow: hidden">
	<div class="Title1" style="float: left">
	 ...
	 <a href="javascript:addLangParam('en');"><img
			src="<c:url value='/static/en.gif' />" /></a> |
			 <a href="javascript:addLangParam('ru');"><img
			src="<c:url value='/static/ru.gif' />" /></a> |
			 <a href="javascript:addLangParam('et');"><img
