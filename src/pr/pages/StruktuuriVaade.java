...
import pr.service.TypeTreeService;
...
public class StruktuuriVaade {
	...
	@RequestMapping(value = "/naitaStruktuuriVaade")
	public String showTypeTree(ModelMap model){
	  			
		System.out.println("Show StuktuuriVaade");
	...
	@RequestMapping(value="/naitaStuktuuriVaade", params="root", produces="application/json;charset=UTF-8")
