...
public class AlluvusRaport {
	...
	@RequestMapping(value = "/naitaAlluvusRaport")
	public String naitaAlluvusRaport(ModelMap model, HttpSession session){
	...
	public String languageChange(HttpSession session, ModelMap model){
		...
		if (unitId != null && unitId > 0) {
			...
			return naitaAlluvusRaport(model, session);
		}
